...
//             const results = await touristSpotCollection.insertOne(newTouristSpot);
//             res.send(results)
//         })
...
async function run() {
    try {
        ...
        //     const coffee = {
        //         $set: {
        //             name: updatedTouristSpot.name,
        //             quantity: updatedTouristSpot.quantity,
        //             supplier: updatedTouristSpot.supplier,
        //             taste: updatedTouristSpot.taste,
        //             category: updatedTouristSpot.category,
        //             details: updatedTouristSpot.details,
